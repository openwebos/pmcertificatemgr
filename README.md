...
Summary
-------
certificate storage and wrapper API on OpenSSL cert manipulation functions
...
`Documentation/PmCertificateMgr/html/index.html`

To install the generated documentation, enter:

    $ [sudo] make install-docs

The documentation will be installed to `usr/share/doc/PmCertificateMgr/html` under
